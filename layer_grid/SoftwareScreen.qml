...
FocusScope
{
    ...
    Item
    {
        ...
        Item
        {
            ...
            height: Math.round(gamesHeaderHeight)
            z: 5

            Image
            {
                id: headerIcon
                width: Math.round(gamesHeaderIcon)
                height: width
                ...
                anchors {
                    top: parent.top; topMargin: Math.round(gamesHeaderNavTop)
                ...
                Text
                {
                    ...
                    font.pixelSize: Math.round(gamesCategoryTitle)
                    font.bold: true
                    anchors {
        ...
        GridView
        {
            ...
            preferredHighlightBegin: Math.round(gamesGridMarginTop)
            preferredHighlightEnd: Math.round(sc6)
            ...
            Component
            {
                ...
                Item
                {
                    ...
                    Rectangle {
                        ...
                        height: Math.round(gamesBubbleHeight)
                        color: "white"
                        radius: vpx(4)
                        visible: !modelData.assets.logo
                        ...
                        Text {
                            ...
                            text: modelData.title
                            color: theme.accent
                            font.pixelSize: Math.round(gamesBubbleText)
                            font.bold: true
                            font.family: titleFont.name
                    ...
                    Image {
                        ...
                        width: vpx(17)
                        height: Math.round(gamesBubbleTriangleHeight)
