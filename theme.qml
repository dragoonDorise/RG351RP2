...
FocusScope
{
    ...
    property var bottomNavButtonSize: screenheight*0.08
    property var bottomNavButtonText: screenheight*0.05
    
    property var platformMarginTop: 0
    property var headerMarginTop: 0
    property var headerLogo: screenheight*0.0833
    property var headerTime: screenheight*0.04
    property var platformBox: 640
    
    
    
    property var platformText: screenheight*0.025
    property var selectedPlatformTitle: screenheight*0.05
    property var platformBubbleBottom: screenheight*0.02
    
    
    property var gamesHeaderHeight: screenheight*0.1222
    property var gamesHeaderIcon: screenheight*0.0611
    property var gamesHeaderNavTop: screenheight*0.0416
    property var gamesCategoryTitle: screenheight*0.0277
    property var gamesGridMarginTop: screenheight*0.1388
    property var sc6: screenheight*0.6527
    property var sc7: screenheight*0.0194
    property var gamesBubbleHeight: screenheight*0.0611
    property var gamesBubbleText: screenheight*0.0422
    property var gamesBubbleTriangleHeight: screenheight*0.02
